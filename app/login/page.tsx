...
export default function LoginPage() {
  ...
  const redirectPath = new URLSearchParams(typeof window !== "undefined" ? window.location.search : "").get("redirect");
  ...
  // Links generated by the old protected-home middleware may still point here.
  // The home page is now public, so send those visitors to the catalog instead.
  React.useEffect(() => {
    if (redirectPath === "/") {
      router.replace("/");
    }
